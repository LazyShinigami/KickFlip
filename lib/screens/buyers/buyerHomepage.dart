...
class BuyerHomepage extends StatefulWidget {
  const BuyerHomepage({super.key, required this.uID});
  final int uID;
  @override
  State<BuyerHomepage> createState() => _BuyerHomepageState(uID);
}

class _BuyerHomepageState extends State<BuyerHomepage> {
  _BuyerHomepageState(this.uID);
  final int uID;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //
      bottomNavigationBar:
          CustomBottomNavigationBar(selectedIndex: _selectedIndex, uID: uID),
    );
  }
}
