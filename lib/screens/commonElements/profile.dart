...
class ProfilePage extends StatelessWidget {
  const ProfilePage({super.key, required this.accountType, required this.uID});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: CustomBottomNavigationBar(
          selectedIndex: _selectedIndex, accountType: accountType, uID: uID),
    );
  }
}
