...
class AddListingPage extends StatefulWidget {
  AddListingPage({super.key, required this.uID});
  final int uID;
...
class _AddListingPageState extends State<AddListingPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: CustomBottomNavigationBar(
          selectedIndex: _currentIndex, accountType: 'seller', uID: widget.uID),
    );
  }
  ...
  // function to actually get the image
  // Future getImageGallery({required String type}) async {
  //   File? _image;
