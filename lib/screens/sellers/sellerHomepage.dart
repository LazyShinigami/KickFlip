...
class SellerHomepage extends StatelessWidget {
  SellerHomepage({super.key, required this.uID});
  final int uID;
  final int _currentIndex = 0;

  // Get this from the login screen
  SellerData sellerData = SellerData(
    sID: 12345,
    name: 'Saudgar',
    email: 'saudagar.op@gmail.com',
  );
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              ManageListingsWidget(productsList: productsList, uID: uID),
              const SizedBox(height: 30),
            ],
          ),
        ),
...
class ManageListingsWidget extends StatelessWidget {
  const ManageListingsWidget(
      {super.key, required this.productsList, required this.uID});
  final int uID;
          ...
          GestureDetector(
            onTap: () {
              ...
              Navigator.pushAndRemoveUntil(context,
                ...
                return const SellerAllListingsPage(uID: 1232);
              }), (route) => false);
            },
            child: Row(
